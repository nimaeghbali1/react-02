            ...
            <main className="w-[375px] h-[868px] m-auto px-[24px] overflow-auto">
                <div className="h-[100px] flex items-center">
                    ...
                    <div className=" flex justify-around w-[270px]">
                        <p className="text-gray-700 font-semibold text-[20px] ">Notifications</p>
                    </div>
                </div>
                <div className="mt-10">
                    <ul>
                            ...
                            <button formTarget="_blank" onClick={() => {
                                ...
                                <div className="flex w-full ">
                                    ...
                                    <div className="flex justify-between w-full">
                                        <p className="text-[16px] text-gray-700 ml-4 font-medium">Orded canceled</p>
                        ...
                        <li>
                            <button onClick={() => {
                                ...
                                <div className="flex w-full">
                                    <img src="/notification.svg" alt="" className="w-[24px]" />
                                    <div className="flex justify-between w-full">
                                        <p className="text-[16px] text-gray-700 ml-4 font-medium">Change password</p>
                                        <img src="/forward.svg" className="w-[24px]" alt="" />
                                    </div>
                                </div>
                            </button>
