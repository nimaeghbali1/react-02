        ...
        <>
            <main className="w-[375px] h-[868px] m-auto px-[24px] mt-3">
                ...
                <div className="flex mt-3">
                    ...
                    <div className="ml-4">
                        <p className="text-gray-700 text-[14px] font-medium">Jacob U.</p>
                ...
                <div className="p-5 flex">
                    <div className="w-[50%]">
                        ...
                        <p className="text-gray-700 text-[16px] font-medium">53,126</p>
                    </div>
                    <div className="">
                ...
                <div className="p-5 pt-0 flex">
                    <div className="w-[50%]">
                        ...
                        <p className="text-gray-700 text-[16px] font-medium">Feb 2, 2023</p>
                    </div>
                    <div className="">
                ...
                <div className="p-5 pt-0 flex">
                    <div className="w-[50%]">
                        ...
                        <p className="text-gray-700 text-[16px] font-medium">Beginner</p>
                    </div>
                    <div className="">
                        <p className="text-gray-400 text-[16px]">Access</p>
                        <p className="text-gray-700 text-[16px] font-medium">Desktop , Mobile</p>
                    </div>
